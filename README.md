...
3. Activate the newly created Conda environment:
   ...
   ```
## Data Requirements
The analysis pipeline requires cardiac point clouds derived from atlas-registered meshes. The cardiac atlas used for LV registration and motion tracking was developed by Bai et al. (2015) and is available [here](https://github.com/UK-Digital-Heart-Project/Statistical-Shape-Model). Please refer to: 
